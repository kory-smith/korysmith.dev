...
import subsettingImg from '../../../public/images/subsetting.png';
import darkLightFaviconImg from '../../../public/images/dark-light-favicon.png';
...
<Image src={subsettingImg} alt="example of font subsetting" />
...
<Image src={darkLightFaviconImg} alt="dark and light mode favicons" />

### It lazy loads images

Images below the fold won't load until you're about to scroll them into view. The site uses [Astro's Image component](https://docs.astro.build/en/guides/images/) which automatically adds `loading="lazy"` and reserves space to prevent layout shift.
